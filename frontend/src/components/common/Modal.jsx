...
const Modal = ({ open, onClose, title, children, size = 'md' }) => {
  ...
  return (
    ...
    >
      <div
        className={`glass-modal flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-2xl animate-slide-in-right sm:max-h-[85vh] sm:animate-scale-in sm:rounded-2xl ${sizes[size]}`}
      >
