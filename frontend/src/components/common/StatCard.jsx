...
const StatCard = ({ icon: Icon, label, value, tone = 'default', hint, loading = false }) => (
  <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-card transition hover:shadow-card-hover dark:border-gray-800 dark:bg-gray-900">
